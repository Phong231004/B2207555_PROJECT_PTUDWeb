<template>
  <div class="page">
    ...
    <div class="container-fluid chat-container d-flex flex-column">
      <h2 class="text-center py-2 bg-primary text-white">Chat với nhân viên</h2>

      <!-- Khung hiển thị tin nhắn -->
      <div class="chat-box flex-grow-1">
        <div v-for="msg in messages" :key="msg._id" :class="['chat-message', msg.sender === username ? 'my-message' : 'other-message']">
...
export default {
  data() {
    return {
      ...
      messages: [],
      message: "",
      username: "Đọc giả", // Đọc giả
      receiver: "Nhân viên", // Nhân viên
  ...
  methods: {
    sendMessage() {
      ...
      const data = { sender: this.username, receiver: this.receiver, message: this.message };
